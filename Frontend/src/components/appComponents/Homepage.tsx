...
export default function Homepage() {
    ...
    const sareeImages = [
        { src: "/public/S1.png", alt: "Silk Sarees", Discription: "Pure silk sarees with rich zari work" },
        { src: "/public/B1.png", alt: "Banarasi Sarees", Discription: "Handwoven Banarasi silk sarees" },
        { src: "/public/D1.png", alt: "Designer Sarees", Discription: "Contemporary fusion designs" },
        { src: "/public/K1.png", alt: "Kanjivaram Sarees", Discription: "Timeless silk treasures" },
    ]
    ...
    return (
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent">
                    <div className="container mx-auto px-4 h-full flex items-center">
                        <div className="max-w-xl text-white">
                            ...
                            <button className="bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-full text-lg font-semibold transition-all" onClick={() => {
                                if(user){
                                    navigate("/dashboard")
                                    return
                                }
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="flex flex-col items-center text-center group">
                            ...
                            <p className="text-gray-600">Join our growing community of 10,000+ partners</p>
                        </div>
                        <div className="flex flex-col items-center text-center group">
                            <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors">
                            ...
                            <p className="text-gray-600">Attractive commission structure</p>
                        </div>
                        <div className="flex flex-col items-center text-center group">
                            <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors">
                            ...
                            <p className="text-gray-600">Special rewards and recognition</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="relative flex flex-col items-center">
                            <div className="w-20 h-20 bg-primary rounded-full flex items-center justify-center text-white text-2xl font-bold mb-6 shadow-lg">
                                1
                            </div>
                            <h3 className="text-xl font-semibold mb-3">Register & Verify</h3>
                            <p className="text-center text-gray-600">Complete your profile verification process</p>
                            {/* Connector line */}
                        ...
                        <div className="relative flex flex-col items-center">
                            ...
                            <p className="text-center text-gray-600">Select your business starter package</p>
                            {/* Connector line */}
                            <div className="hidden md:block absolute top-10 left-1/2 w-full h-1 bg-gradient-to-r from-primary to-primary/50 -z-10"></div>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center">
                            ...
                            <p className="text-center text-gray-600">Grow your team and expand your business</p>
                            {/* Connector line */}
                            <div className="hidden md:block absolute top-10 left-1/2 w-full h-1 bg-gradient-to-r from-primary to-primary/50 -z-10"></div>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center">
                            ...
                            <p className="text-center text-gray-600">Enjoy lucrative commissions and bonuses</p>
                        </div>
                    </div>
                </div>
            </section>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-500 text-sm">@priyasarees</p>
                      </div>
              ...
              <CardContent className="pt-6">
                <div className="flex gap-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-bold text-gray-900">Anjali Patel</h3>
                        <p className="text-gray-500 text-sm">@anjali_boutique</p>
                      </div>
                      <div className="flex gap-0.5">
                        {[...Array(4)].map((_, i) => (
                          <Star key={i} className="w-4 h-4 fill-primary" />
              ...
              <CardContent className="pt-6">
                <div className="flex gap-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-bold text-gray-900">Meera Reddy</h3>
                        <p className="text-gray-500 text-sm">@meera_silks</p>
                      </div>
                      <div className="flex gap-0.5">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className="w-4 h-4 fill-primary" />
              ...
              <CardContent className="pt-6">
                <div className="flex gap-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-bold text-gray-900">Ritu Verma</h3>
                        <p className="text-gray-500 text-sm">@ritu_ethnic</p>
                      </div>
                      <div className="flex gap-0.5">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className="w-4 h-4 fill-primary" />
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">About Our Legacy</h2>
